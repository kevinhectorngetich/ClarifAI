      ...
      >
        ...
        >
          ...
          <div className="text-sm leading-relaxed pr-8">
            {" "}
            {/* Add right padding to avoid overlap with copy button */}
            {isAssistant ? (
              <div className="prose prose-sm max-w-none">
                <ReactMarkdown
                  components={{
                    ...
                    code: ({ children }) => (
                      <code className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-1 py-0.5 rounded text-xs font-mono">
                        {children}
                      </code>
                    ),
                    h1: ({ children }) => (
